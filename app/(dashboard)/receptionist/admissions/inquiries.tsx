      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyStateText}>No inquiry logs match the current search filters.</Text>
          </View>
        }
        renderItem={({ item }) => (
          <TouchableOpacity 
          ...
          <View style={styles.overlayGlass}>
            <View style={[styles.modalBaseCard, isMobile && { margin: 12, maxHeight: '92%' }]}>
              ...
              <ScrollView style={styles.modalScrollBody} showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.fieldValueNotes}>{selectedInquiry.notes || 'No custom descriptive summary provided.'}</Text>
              </ScrollView>
        ...
        <View style={styles.overlayGlass}>
          <View style={[styles.modalBaseCard, isMobile && { margin: 12, maxHeight: '92%' }]}>
            ...
            >
              ...
              <TextInput style={styles.formInputField} value={form.studentName} onChangeText={(val) => setForm({ ...form, studentName: val })} placeholder="Enter complete full name" placeholderTextColor="#A1A1AA" />

              <Text style={styles.formInputLabel}>Parent or Guardian Name <Text style={{color:'#EF4444'}}>*</Text></Text>
              <TextInput style={styles.formInputField} value={form.parentName} onChangeText={(val) => setForm({ ...form, parentName: val })} placeholder="Enter guardian full name" placeholderTextColor="#A1A1AA" />
              ...
              <TextInput style={styles.formInputField} value={form.gradeOfInterest} onChangeText={(val) => setForm({ ...form, gradeOfInterest: val })} placeholder="e.g. Grade 4, Nursery, Grade 12" placeholderTextColor="#A1A1AA" />
              ...
              <TextInput
                ...
                multiline
                numberOfLines={4}
                placeholder="Log details concerning timing, academic background etc..."
...
const styles = StyleSheet.create({
  ...
  dismissDetailsButtonText: {
    color: '#FFFFFF',
    fontWeight: '600',
    fontSize: 15,
  },
  formInnerScrollContainer: {
    flex: 1,
  },
  formInputLabel: {
    fontSize: 13.5,
