  ...
  const menuConfig = [
    ...
    { 
      ...
      subItems: [
        ...
        { name: "Teacher Chat Room", path: "/parent/communication/chat" }
      ]
    },
    { 
      name: "Examination", 
    ...
    { 
      ...
      subItems: [
        ...
        { name: "Receipt Ledger", path: "/parent/fees/receipts" }
      ]
    },
    { 
      name: "Homework Diary", 
    ...
    <View style={styles.rootContainer}>
      ...
      <View style={styles.contentContainer}>
        <Stack screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="examination/report-card" />
          <Stack.Screen name="examination/results" />
          ...
          <Stack.Screen name="transport/alerts" />
        </Stack>
      </View>
