...
export default function EmergencyAlert() {
  ...
  const sendEmergencyAlert = () => {
    Alert.alert(
      "Emergency Alert",
      "Are you sure you want to send emergency alert? All contacts will be notified immediately.",
      [
  ...
  const cancelEmergency = () => {
    Alert.alert(
      "Cancel Alert",
      "Are you sure you want to cancel emergency mode?",
      [
    ...
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      ...
      <View style={styles.emergencyButtonContainer}>
        <TouchableOpacity
          style={[
            styles.emergencyBtn,
            isEmergencyMode && styles.emergencyBtnActive,
          ]}
        ...
        >
          ...
          <Text style={styles.emergencyBtnText}>
            {isEmergencyMode ? "CANCEL EMERGENCY" : "SEND EMERGENCY ALERT"}
          </Text>
        </TouchableOpacity>
        {isEmergencyMode && (
      ...
      <View style={styles.locationCard}>
        ...
        <Text style={styles.locationText}>
          Your current location will be shared with emergency contacts when you
          send an alert
        </Text>
