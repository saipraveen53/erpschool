          ...
          filteredSubscriptions.map(sub => (
            ...
            >
              ...
              <View style={styles.cardMeta}>
                <View style={[styles.planBadge, { backgroundColor: (planColors[sub.plan] || "#8A6B5D") + "18" }]}>
                  <Text style={[styles.planText, { color: planColors[sub.plan] || "#8A6B5D" }]}>{sub.plan}</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  searchBox: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", paddingHorizontal: 16, paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: "#E6D8D2", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.02, shadowRadius: 4, elevation: 1, gap: 10, marginBottom: 16 },
  searchPlaceholder: { fontSize: 15, color: "#B8A095" },
  ...
  iconWrap: { width: 36, height: 36, borderRadius: 10, backgroundColor: "#F4A460", justifyContent: "center", alignItems: "center", marginRight: 12, flexShrink: 0 },
  cardSchool: { fontSize: 15, fontWeight: "700", color: "#A0522D" },
  cardBilling: { fontSize: 12, color: "#B8A095", marginTop: 2 },
  cardMeta: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 10, borderTopWidth: 1, borderTopColor: "#F4A460", borderBottomWidth: 1, borderBottomColor: "#F4A460", marginBottom: 12 },
  planBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  planText: { fontSize: 13, fontWeight: "700" },
  amountText: { fontSize: 15, fontWeight: "700", color: "#A0522D" },
  manageBtn: { backgroundColor: "#F5F5DC", borderWidth: 1, borderColor: "#E6D8D2", paddingVertical: 10, borderRadius: 8, alignItems: "center" },
  manageBtnText: { fontSize: 14, fontWeight: "600", color: "#A0522D" },
  ...
  actionButton: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 6, borderWidth: 1, borderColor: "#E6D8D2", backgroundColor: "#fff" },
  actionButtonText: { fontSize: 13, fontWeight: "500", color: "#A0522D" },
});
