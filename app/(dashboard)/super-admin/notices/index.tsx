...
const NOTICE_BASE_URL = "http://192.168.88.20:8083";
...
export default function NoticesManagement() {
  ...
  const fetchNotices = async () => {
    try {
      ...
      const response = await rootApi.get(
        `${NOTICE_BASE_URL}/api/student/notice/all`,
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await rootApi.post(
        `${NOTICE_BASE_URL}/api/student/notice/create`,
        createPayload,
      );
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerSubtitle}>
            Manage announcements and alerts for everyone in the school.
          </Text>
        </View>
                    ...
                    >
                      ...
                      >
                        <Megaphone
                          size={20}
                          color={
                            item.noticeType === "URGENT" ? "#e11d48" : "#A0522D"
                          }
                        />
                      </View>
                      <View style={{ flex: 1 }}>
      ...
      <Modal visible={modalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View
            style={[styles.modalContent, { width: isMobile ? "90%" : 500 }]}
          >
            ...
            <ScrollView>
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(t) =>
                    setFormData({ ...formData, noticeName: t })
                  }
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(t) =>
                    setFormData({ ...formData, noticeDescription: t })
                  }
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <View style={[styles.formGroup, { flex: 1 }]}>
                  ...
                  <View style={{ flexDirection: "row", gap: 8, marginTop: 4 }}>
                    <TouchableOpacity
                      style={[
                        styles.radioBtn,
                        formData.noticeType === "GENERAL" &&
                          styles.radioBtnActive,
                      ]}
                      onPress={() =>
                        setFormData({ ...formData, noticeType: "GENERAL" })
                      }
                    >
                      <Text
                        style={[
                    ...
                    <TouchableOpacity
                      style={[
                        styles.radioBtn,
                        formData.noticeType === "URGENT" &&
                          styles.radioBtnActive,
                      ]}
                      onPress={() =>
                        setFormData({ ...formData, noticeType: "URGENT" })
                      }
                    >
                      <Text
                        style={[
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) =>
                      setFormData({ ...formData, noticeDate: t })
                    }
