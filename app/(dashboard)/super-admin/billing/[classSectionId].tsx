...
export default function ClassBillingDetails() {
    ...
    const fetchStudents = async () => {
      ...
      try {
        ...
        const response = await rootApi.get(
          `${BILLING_BASE_URL}/api/student/fee/admin/class-status/${classSectionId}`,
        );
        if (response.data) {
  ...
  const openStudentSummary = async (student: any) => {
    ...
    try {
      const response = await rootApi.get(
        `${BILLING_BASE_URL}/api/student/fee/student/summary/${student.studentId}`,
      );
      if (response.data) {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { padding: isMobile ? 14 : 24 }]}>
        ...
        <View>
          <Text style={[styles.headerTitle, { fontSize: isMobile ? 18 : 24 }]}>
            Class Fee Status
          </Text>
          <Text style={styles.headerSubtitle}>
            Check and update fee records for each student in this class.
          </Text>
        </View>
      </View>
        ...
        {loading ? (
          ...
          <View style={styles.tableContainer}>
            ...
            {students.map((student, idx) => {
              const isPaid =
                student.status === "PAID" || student.balanceAmount === 0;
              return (
                <TouchableOpacity
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      {isMobile && (
                        <Text style={styles.rollNoMobile}>
                  ...
                  {!isMobile && (
                    <View
                      style={[styles.td, { flex: 1.5, alignItems: "center" }]}
                    >
                  ...
                  <View
                    style={[styles.td, { flex: 2, alignItems: "flex-end" }]}
                  >
                  ...
                  >
                    <Text
                      style={[
                        ...
                        isPaid ? { color: "#16a34a" } : { color: "#dc2626" },
                      ]}
                    >
            ...
            {selectedStudent && (
              <View style={styles.studentProfileMini}>
                ...
                <View style={{ marginLeft: 16 }}>
                  ...
                  <Text style={styles.studentProfileId}>
                    ID: {selectedStudent.studentId} • Roll:{" "}
              ...
              <View style={styles.summaryBox}>
                <View style={styles.summaryRow}>
                  ...
                  <Text style={styles.summaryValue}>
                    {formatCurrency(studentSummary.totalFee)}
                  </Text>
                </View>
                <View style={styles.summaryRow}>
                  <Text style={styles.summaryLabel}>Paid Amount</Text>
                  <Text style={[styles.summaryValue, { color: "#16a34a" }]}>
                    {formatCurrency(studentSummary.paidAmount)}
                  </Text>
                </View>
                <View
                  style={[
                ...
                >
                  ...
                  >
                    {formatCurrency(studentSummary.pendingAmount)}
                  </Text>
                </View>
              </View>
            ) : (
