...
const HOLIDAY_BASE_URL = "http://192.168.88.20:8083";
  ...
  const fetchHolidays = async () => {
    try {
      ...
      const response = await rootApi.get(
        `${HOLIDAY_BASE_URL}/api/student/calender/${year}/${month}`,
      );
      if (response.data) {
        ...
        >
          ...
          {holiday && (
            <View
              style={[
                styles.holidayBadge,
                isMobile && { paddingHorizontal: 2, paddingVertical: 1 },
              ]}
            >
              <Text style={styles.holidayBadgeText} numberOfLines={2}>
                {holiday.title}
              </Text>
            </View>
          )}
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerSubtitle}>
            View and manage school holidays and important dates.
          </Text>
        </View>
      </View>
      ...
      <Modal visible={modalVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View
            style={[styles.modalContent, { width: isMobile ? "90%" : 400 }]}
          >
            ...
            <View style={styles.formGroup}>
              ...
              >
                <Switch
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, fullDay: val })
                  }
